...
namespace AimaneCouissi\NegotiableQuoteCloseAdminUi\Plugin\Magento\NegotiableQuote\Block\Adminhtml\Quote;
...
class ViewPlugin
{
    ...
    public function beforeSetLayout(View $subject, LayoutInterface $layout): array
    {
        ...
        $subject->addButton('quote_close', $this->buildCloseButtonData($subject, (string)$quote->getStatus()));
        return [$layout];
    }
     ...
     * @return array
     */
    private function buildCloseButtonData(View $subject, string $status): array
    {
